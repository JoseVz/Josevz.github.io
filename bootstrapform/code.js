function checkEmail()
{
    ...
    if(email == "")//conditional expression, when is true, the the code in the block will be executed
    {
    ...
    if(confirm == "")//conditional expression, when is true, the the code in the block will be executed
    {
